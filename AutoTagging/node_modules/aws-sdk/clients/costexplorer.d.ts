...
declare namespace CostExplorer {
  ...
  export interface GetCostForecastRequest {
    ...
    Filter?: Expression;
    /**
     * Cost Explorer always returns the mean forecast as a single point. You can request a prediction interval around the mean by specifying a confidence level. The higher the confidence level, the more confident Cost Explorer is about the actual value falling in the prediction interval. Higher confidence levels credentials in wider prediction intervals.
     */
  ...
  export interface ResultByTime {
    /**
     * The time period covered by a credentials.
     */
    TimePeriod?: DateInterval;
    /**
    ...
    Groups?: Groups;
    /**
     * Whether this credentials is estimated.
     */
    Estimated?: Estimated;
  }
  ...
  export interface UtilizationByTime {
    ...
    TimePeriod?: DateInterval;
    /**
     * The groups that are included in this utilization credentials.
     */
