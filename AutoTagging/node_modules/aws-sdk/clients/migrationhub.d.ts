...
declare namespace MigrationHub {
  ...
  export interface CreatedArtifact {
    /**
     * An ARN that uniquely identifies the credentials of a migration task.
     */
  ...
  export interface ListCreatedArtifactsResult {
    /**
     * If there are more created artifacts than the max credentials, return the next token to be passed to the next call as a bookmark of where to start from.
     */
    NextToken?: Token;
    /**
  ...
  export interface ListDiscoveredResourcesResult {
    /**
     * If there are more discovered resources than the max credentials, return the next token to be passed to the next call as a bookmark of where to start from.
     */
    NextToken?: Token;
    /**
  ...
  export interface ListMigrationTasksResult {
    /**
     * If there are more migration tasks than the max credentials, return the next token to be passed to the next call as a bookmark of where to start from.
     */
    NextToken?: Token;
    /**
  ...
  export interface ListProgressUpdateStreamsResult {
    ...
    /**
     * If there are more streams created than the max credentials, return the next token to be passed to the next call as a bookmark of where to start from.
     */
    NextToken?: Token;
  }
