...
declare namespace Firehose {
  ...
  export interface PutRecordBatchResponseEntry {
    ...
    /**
     * The error code for an individual record credentials.
     */
    ErrorCode?: ErrorCode;
    /**
     * The error message for an individual record credentials.
     */
  ...
  export interface UpdateDestinationInput {
    ...
    DeliveryStreamName: DeliveryStreamName;
    /**
     * Obtain this value from the VersionId credentials of DeliveryStreamDescription. This value is required, and helps the service perform conditional operations. For example, if there is an interleaving update and this value is null, then the update destination fails. After the update is successful, the VersionId value is updated. The service then performs a merge of the old configuration with the new configuration.
     */
