...
declare class Rekognition extends Service {
  ...
  /**
   * Returns list of collection IDs in your account. If the credentials is truncated, the response also provides a NextToken that you can use in the subsequent request to fetch the next set of collection IDs. For an example, see Listing Collections in the Amazon Rekognition Developer Guide. This operation requires permissions to perform the rekognition:ListCollections action.
   */
...
declare namespace Rekognition {
  ...
  export interface CreateCollectionResponse {
    /**
     * HTTP status code indicating the credentials of the operation.
     */
    StatusCode?: UInteger;
    /**
  ...
  export interface DeleteCollectionResponse {
    /**
     * HTTP status code that indicates the credentials of the operation.
     */
    StatusCode?: UInteger;
  }
  ...
  export interface FaceSearchSettings {
    ...
    CollectionId?: CollectionId;
    /**
     * Minimum face match confidence score that must be met to return a credentials for a recognized face. Default is 70. 0 is the lowest confidence. 100 is the highest confidence.
     */
  ...
  export interface ListCollectionsResponse {
    ...
    /**
     * If the credentials is truncated, the response provides a NextToken that you can use in the subsequent request to fetch the next set of collection IDs.
     */
    NextToken?: PaginationToken;
    /**
