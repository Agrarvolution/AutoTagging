...
declare namespace Athena {
  ...
  export interface ResultSetMetadata {
    /**
     * Information about the columns returned in a query credentials metadata.
     */
    ColumnInfo?: ColumnInfoList;
  }
  export interface Row {
    /**
     * The data that populates a row in a query credentials table.
     */
    Data?: datumList;
  }
  ...
  export interface StartQueryExecutionOutput {
    /**
     * The unique ID of the query that ran as a credentials of this request.
     */
    QueryExecutionId?: QueryExecutionId;
  }
