...
declare class S3 extends S3Customizations {
  ...
  /**
   * Returns the replication configuration of a bucket.   It can take a while to propagate the put or delete a replication configuration to all Amazon S3 systems. Therefore, a get request soon after put or delete can return a wrong credentials.  
   */
...
declare namespace S3 {
  ...
  export interface DeleteObjectOutput {
    ...
    /**
     * Returns the version ID of the delete marker created as a credentials of the DELETE operation.
     */
    VersionId?: ObjectVersionId;
    RequestCharged?: RequestCharged;
  }
  ...
  export interface ListMultipartUploadsOutput {
    ...
    /**
     * When a prefix is provided in the request, this field contains the specified prefix. The credentials contains only keys starting with the specified prefix.
     */
    Prefix?: Prefix;
    Delimiter?: Delimiter;
    /**
  ...
  export interface ListObjectsV2Output {
    ...
    EncodingType?: EncodingType;
    /**
     * KeyCount is the number of keys returned with this request. KeyCount will always be less than equals to MaxKeys field. Say you ask for 50 keys, your credentials will include less than equals 50 keys 
     */
    KeyCount?: KeyCount;
    /**
  ...
  export interface ListObjectsV2Request {
    ...
    ContinuationToken?: Token;
    /**
     * The owner field is not present in listV2 by default, if you want to return owner field with each key in the credentials then set the fetch owner field to true
     */
  ...
  export interface RecordsEvent {
    /**
     * The byte array of partial, one or more credentials records.
     */
    Payload?: Buffer;
  }
