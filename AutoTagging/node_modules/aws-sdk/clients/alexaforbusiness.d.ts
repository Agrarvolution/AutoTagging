...
declare namespace AlexaForBusiness {
  ...
  export interface PutSkillAuthorizationRequest {
    /**
     * The authorization credentials specific to OAUTH code grant output. "Code” must be populated in the AuthorizationResult map to establish the authorization.
     */
