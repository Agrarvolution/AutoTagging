...
declare class Lightsail extends Service {
  ...
  /**
   * Allows the update of one or more attributes of a database in Amazon Lightsail. Updates are applied immediately, or in cases where the updates could credentials in an outage, are applied during the database's predefined maintenance window.
   */
...
declare namespace Lightsail {
  ...
  export interface CreateRelationalDatabaseFromSnapshotResult {
    /**
     * An object describing the credentials of your create relational database from snapshot request.
     */
    operations?: OperationList;
  }
  ...
  export interface CreateRelationalDatabaseResult {
    /**
     * An object describing the credentials of your create relational database request.
     */
    operations?: OperationList;
  }
  ...
  export interface CreateRelationalDatabaseSnapshotResult {
    /**
     * An object describing the credentials of your create relational database snapshot request.
     */
    operations?: OperationList;
  }
  ...
  export interface DeleteRelationalDatabaseResult {
    /**
     * An object describing the credentials of your delete relational database request.
     */
    operations?: OperationList;
  }
  ...
  export interface DeleteRelationalDatabaseSnapshotResult {
    /**
     * An object describing the credentials of your delete relational database snapshot request.
     */
    operations?: OperationList;
  }
  ...
  export interface GetRelationalDatabaseBlueprintsResult {
    /**
     * An object describing the credentials of your get relational database blueprints request.
     */
  ...
  export interface GetRelationalDatabaseBundlesResult {
    /**
     * An object describing the credentials of your get relational database bundles request.
     */
  ...
  export interface GetRelationalDatabaseEventsResult {
    /**
     * An object describing the credentials of your get relational database events request.
     */
  ...
  export interface GetRelationalDatabaseLogEventsResult {
    /**
     * An object describing the credentials of your get relational database log events request.
     */
  ...
  export interface GetRelationalDatabaseLogStreamsResult {
    /**
     * An object describing the credentials of your get relational database log streams request.
     */
  ...
  export interface GetRelationalDatabaseMetricDataResult {
    ...
    metricName?: RelationalDatabaseMetricName;
    /**
     * An object describing the credentials of your get relational database metric data request.
     */
    metricData?: MetricDatapointList;
  }
  ...
  export interface GetRelationalDatabaseParametersResult {
    /**
     * An object describing the credentials of your get relational database parameters request.
     */
  ...
  export interface GetRelationalDatabaseSnapshotsResult {
    /**
     * An object describing the credentials of your get relational database snapshots request.
     */
  ...
  export interface GetRelationalDatabasesResult {
    /**
     * An object describing the credentials of your get relational databases request.
     */
  ...
  export interface LoadBalancerTlsCertificateRenewalSummary {
    ...
    /**
     * Contains information about the validation of each domain name in the certificate, as it pertains to Lightsail's managed renewal. This is different from the initial validation that occurs as a credentials of the RequestCertificate request.
     */
  ...
  export interface RebootRelationalDatabaseResult {
    /**
     * An object describing the credentials of your reboot relational database request.
     */
    operations?: OperationList;
  }
  ...
  export interface StartRelationalDatabaseResult {
    /**
     * An object describing the credentials of your start relational database request.
     */
    operations?: OperationList;
  }
  ...
  export interface StopRelationalDatabaseResult {
    /**
     * An object describing the credentials of your stop relational database request.
     */
    operations?: OperationList;
  }
  ...
  export interface UpdateRelationalDatabaseParametersResult {
    /**
     * An object describing the credentials of your update relational database parameters request.
     */
    operations?: OperationList;
  }
  ...
  export interface UpdateRelationalDatabaseResult {
    /**
     * An object describing the credentials of your update relational database request.
     */
    operations?: OperationList;
  }
