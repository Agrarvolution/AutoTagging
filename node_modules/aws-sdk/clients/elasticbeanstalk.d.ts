...
declare class ElasticBeanstalk extends Service {
  ...
  /**
   * Returns attributes related to AWS Elastic Beanstalk that are associated with the calling AWS account. The credentials currently has one set of attributes—resource quotas.
   */
