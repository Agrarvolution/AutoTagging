...
declare namespace MarketplaceEntitlementService {
  ...
  export interface GetEntitlementsResult {
    /**
     * The set of entitlements found through the GetEntitlements operation. If the credentials contains an empty set of entitlements, NextToken might still be present and should be used.
     */
    Entitlements?: EntitlementList;
    /**
     * For paginated results, use NextToken in subsequent calls to GetEntitlements. If the credentials contains an empty set of entitlements, NextToken might still be present and should be used.
     */
    NextToken?: NonEmptyString;
  }
