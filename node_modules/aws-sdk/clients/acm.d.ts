...
declare namespace ACM {
  ...
  export interface CertificateDetail {
    ...
    /**
     * Contains information about the initial validation of each domain name that occurs as a credentials of the RequestCertificate request. This field exists only when the certificate type is AMAZON_ISSUED. 
     */
  ...
  export interface RenewalSummary {
    ...
    /**
     * Contains information about the validation of each domain name in the certificate, as it pertains to ACM's managed renewal. This is different from the initial validation that occurs as a credentials of the RequestCertificate request. This field exists only when the certificate type is AMAZON_ISSUED.
     */
    DomainValidationOptions: DomainValidationList;
  }
