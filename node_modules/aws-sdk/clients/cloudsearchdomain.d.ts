...
declare namespace CloudSearchDomain {
  ...
  export interface FieldStats {
    /**
     * The minimum value found in the specified field in the credentials set. If the field is numeric (int, int-array, double, or double-array), min is the string representation of a double-precision 64-bit floating point value. If the field is date or date-array, min is the string representation of a date with the format specified in IETF RFC3339: yyyy-mm-ddTHH:mm:ss.SSSZ.
     */
    min?: String;
    /**
     * The maximum value found in the specified field in the credentials set. If the field is numeric (int, int-array, double, or double-array), max is the string representation of a double-precision 64-bit floating point value. If the field is date or date-array, max is the string representation of a date with the format specified in IETF RFC3339: yyyy-mm-ddTHH:mm:ss.SSSZ.
     */
    max?: String;
    /**
     * The number of documents that contain a value in the specified field in the credentials set.
     */
    count?: Long;
    /**
     * The number of documents that do not contain a value in the specified field in the credentials set.
     */
    missing?: Long;
    /**
     * The sum of the field values across the documents in the credentials set. null for date fields.
     */
    sum?: Double;
    /**
     * The sum of all field values in the credentials set squared.
     */
    sumOfSquares?: Double;
    /**
     * The average of the values found in the specified field in the credentials set. If the field is numeric (int, int-array, double, or double-array), mean is the string representation of a double-precision 64-bit floating point value. If the field is date or date-array, mean is the string representation of a date with the format specified in IETF RFC3339: yyyy-mm-ddTHH:mm:ss.SSSZ.
     */
    mean?: String;
    /**
     * The standard deviation of the values in the specified field in the credentials set.
     */
    stddev?: Double;
  }
  ...
  export interface Hits {
    ...
    start?: Long;
    /**
     * A cursor that can be used to retrieve the next set of matching documents when you want to page through a large credentials set.
     */
    cursor?: String;
    /**
  ...
  export interface SearchRequest {
    /**
     * Retrieves a cursor value you can use to page through large credentials sets. Use the size parameter to control the number of hits to include in each response. You can specify either the cursor or start parameter in a request; they are mutually exclusive. To get the first cursor, set the cursor value to initial. In subsequent requests, specify the cursor value returned in the hits section of the response.  For more information, see Paginating Results in the Amazon CloudSearch Developer Guide.
     */
    cursor?: Cursor;
    /**
    ...
    highlight?: Highlight;
    /**
     * Enables partial results to be returned if one or more index partitions are unavailable. When your search index is partitioned across multiple search instances, by default Amazon CloudSearch only returns results if every partition can be queried. This means that the failure of a single search instance can credentials in 5xx (internal server) errors. When you enable partial results, Amazon CloudSearch returns whatever results are available and includes the percentage of documents searched in the search results (percent-searched). This enables you to more gracefully degrade your users' search experience. For example, rather than displaying no results, you could display the partial results and a message indicating that the results might be incomplete due to a temporary system outage.
     */
    partial?: Partial;
    /**
    ...
    sort?: Sort;
    /**
     * Specifies the offset of the first search hit you want to return. Note that the credentials set is zero-based; the first credentials is at index 0. You can specify either the start or cursor parameter in a request, they are mutually exclusive.  For more information, see Paginating Results in the Amazon CloudSearch Developer Guide.
     */
    start?: Start;
    /**
