...
declare namespace DynamoDBStreams {
  ...
  export interface ListStreamsOutput {
    ...
    Streams?: StreamList;
    /**
     * The stream ARN of the item where the operation stopped, inclusive of the previous credentials set. Use this value to start a new operation, excluding this value in the new request. If LastEvaluatedStreamArn is empty, then the "last page" of results has been processed and there is no more data to be retrieved. If LastEvaluatedStreamArn is not empty, it does not necessarily mean that there is more data in the credentials set. The only way to know when you have reached the end of the credentials set is when LastEvaluatedStreamArn is empty.
     */
  ...
  export interface StreamDescription {
    ...
    /**
     * The shard ID of the item where the operation stopped, inclusive of the previous credentials set. Use this value to start a new operation, excluding this value in the new request. If LastEvaluatedShardId is empty, then the "last page" of results has been processed and there is currently no more data to be retrieved. If LastEvaluatedShardId is not empty, it does not necessarily mean that there is more data in the credentials set. The only way to know when you have reached the end of the credentials set is when LastEvaluatedShardId is empty.
     */
