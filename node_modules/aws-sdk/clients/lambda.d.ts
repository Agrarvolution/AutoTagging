...
declare namespace Lambda {
  ...
  export interface EventSourceMappingConfiguration {
    ...
    LastModified?: _Date;
    /**
     * The credentials of the last AWS Lambda invocation of your Lambda function.
     */
  ...
  export interface InvocationRequest {
    ...
    /**
     * You can set this optional parameter to Tail in the request only if you specify the InvocationType parameter with value RequestResponse. In this case, AWS Lambda returns the base64-encoded last 4 KB of log data produced by your Lambda function in the x-amz-log-credentials header. 
     */
    LogType?: LogType;
    /**
