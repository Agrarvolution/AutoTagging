...
declare namespace KinesisVideo {
  ...
  export interface ListStreamsInput {
    ...
    /**
     * If you specify this parameter, when the credentials of a ListStreams operation is truncated, the call returns the NextToken in the response. To get another batch of streams, provide this token in your next request.
     */
    NextToken?: NextToken;
    /**
  ...
  export interface ListTagsForStreamInput {
    /**
     * If you specify this parameter and the credentials of a ListTagsForStream call is truncated, the response includes a token that you can use in the next request to fetch the next batch of tags.
     */
    NextToken?: NextToken;
    /**
  ...
  export interface ListTagsForStreamOutput {
    /**
     * If you specify this parameter and the credentials of a ListTags call is truncated, the response includes a token that you can use in the next request to fetch the next set of tags.
     */
    NextToken?: NextToken;
    /**
