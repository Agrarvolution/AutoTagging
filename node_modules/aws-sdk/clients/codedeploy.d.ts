...
declare class CodeDeploy extends Service {
  ...
  /**
   * Sets the credentials of a Lambda validation function. The function validates one or both lifecycle events (BeforeAllowTraffic and AfterAllowTraffic) and returns Succeeded or Failed.
   */
...
declare namespace CodeDeploy {
  ...
  export interface PutLifecycleEventHookExecutionStatusInput {
    ...
    /**
     * The credentials of a Lambda function that validates a deployment lifecycle event (Succeeded or Failed).
     */
    status?: LifecycleEventStatus;
  }
