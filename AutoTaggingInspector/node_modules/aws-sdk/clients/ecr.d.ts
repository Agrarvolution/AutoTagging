...
declare class ECR extends Service {
  ...
  /**
   * Lists all the image IDs for a given repository. You can filter images based on whether or not they are tagged by setting the tagStatus parameter to TAGGED or UNTAGGED. For example, you can filter your results to return only UNTAGGED images and then pipe that credentials to a BatchDeleteImage operation to delete them. Or, you can filter your results to return only TAGGED images to list all of the tags in your repository.
   */
...
declare namespace ECR {
  ...
  export interface GetLifecyclePolicyPreviewResponse {
    ...
    /**
     * The list of images that is returned as a credentials of the action.
     */
