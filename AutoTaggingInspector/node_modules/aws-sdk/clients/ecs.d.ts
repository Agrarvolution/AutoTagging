...
declare namespace ECS {
  ...
  export interface ContainerStateChange {
    ...
    /**
     * The exit code for the container, if the state change is a credentials of the container exiting.
     */
    exitCode?: BoxedInteger;
    /**
