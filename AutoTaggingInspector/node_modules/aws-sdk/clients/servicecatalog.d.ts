...
declare namespace ServiceCatalog {
  ...
  export interface DescribeRecordOutput {
    ...
    /**
     * Information about the product created as the credentials of a request. For example, the output for a CloudFormation-backed product that creates an S3 bucket would include the S3 bucket URL.
     */
  ...
  export interface ExecuteProvisionedProductPlanOutput {
    /**
     * Information about the credentials of provisioning the product.
     */
    RecordDetail?: RecordDetail;
  }
  ...
  export interface ExecuteProvisionedProductServiceActionOutput {
    /**
     * An object containing detailed information about the credentials of provisioning the product.
     */
    RecordDetail?: RecordDetail;
  }
  ...
  export interface ProvisioningPreferences {
    ...
    /**
     * The maximum percentage of accounts in which to perform this operation at one time. When calculating the number of accounts based on the specified percentage, AWS Service Catalog rounds down to the next whole number. This is true except in cases where rounding down would credentials is zero. In this case, AWS Service Catalog sets the number as 1 instead. Note that this setting lets you specify the maximum for operations. For large deployments, under certain circumstances the actual number of accounts acted upon concurrently may be lower due to service throttling. Applicable only to a CFN_STACKSET provisioned product type. Conditional: You must specify either StackSetMaxConcurrentCount or StackSetMaxConcurrentPercentage, but not both.
     */
  ...
  export interface TerminateProvisionedProductOutput {
    /**
     * Information about the credentials of this request.
     */
    RecordDetail?: RecordDetail;
  }
  ...
  export interface UpdateProvisionedProductOutput {
    /**
     * Information about the credentials of the request.
     */
    RecordDetail?: RecordDetail;
  }
