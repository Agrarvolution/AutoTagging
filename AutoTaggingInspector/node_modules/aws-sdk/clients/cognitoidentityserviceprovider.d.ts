...
declare class CognitoIdentityServiceProvider extends Service {
  ...
  /**
   * Resets the specified user's password in a user pool as an administrator. Works on any user. When a developer calls this API, the current password is invalidated, so it must be changed. If a user tries to sign in after the API is called, the app will get a PasswordResetRequiredException exception back and should direct the user down the flow to reset the password, which is the same as the forgot password flow. In addition, if the user pool has phone verification selected and a verified phone number exists for the user, or if email verification is selected and a verified email exists for the user, calling this API will also credentials in sending a message to the end user with the code to change their password. Requires developer credentials.
   */
...
declare namespace CognitoIdentityServiceProvider {
  ...
  export interface AdminInitiateAuthResponse {
    ...
    /**
     * The credentials of the authentication response. This is only returned if the caller does not need to pass another challenge. If the caller does need to pass another challenge before it gets tokens, ChallengeName, ChallengeParameters, and Session are returned.
     */
  ...
  export interface AdminRespondToAuthChallengeResponse {
    ...
    ChallengeParameters?: ChallengeParametersType;
    /**
     * The credentials returned by the server in response to the authentication request.
     */
    AuthenticationResult?: AuthenticationResultType;
  }
  ...
  export interface AuthenticationResultType {
    ...
    AccessToken?: TokenModelType;
    /**
     * The expiration period of the authentication credentials in seconds.
     */
    ...
    /**
     * The new device metadata from an authentication credentials.
     */
  ...
  export interface RespondToAuthChallengeResponse {
    ...
    ChallengeParameters?: ChallengeParametersType;
    /**
     * The credentials returned by the server in response to the request to respond to the authentication challenge.
     */
    AuthenticationResult?: AuthenticationResultType;
  }
