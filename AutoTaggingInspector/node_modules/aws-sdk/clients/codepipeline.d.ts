...
declare namespace CodePipeline {
  ...
  export interface ActionDeclaration {
    ...
    configuration?: ActionConfigurationMap;
    /**
     * The name or ID of the credentials of the action declaration, such as a test or build artifact.
     */
  ...
  export interface PutApprovalResultInput {
    ...
    actionName: ActionName;
    /**
     * Represents information about the credentials of the approval request.
     */
  ...
  export interface ThirdPartyJobData {
    ...
    inputArtifacts?: ArtifactList;
    /**
     * The name of the artifact that will be the credentials of the action, if any. This name might be system-generated, such as "MyBuiltApp", or might be defined by the user when the action is created.
     */
    outputArtifacts?: ArtifactList;
    /**
     * Represents an AWS session credentials object. These credentials are temporary credentials that are issued by AWS Secure Token Service (STS). They can be used to access input and output artifacts in the Amazon S3 bucket used to store artifact for the pipeline in AWS CodePipeline. 
