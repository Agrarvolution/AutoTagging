...
declare namespace CodeCommit {
  ...
  export interface DescribePullRequestEventsInput {
    ...
    nextToken?: NextToken;
    /**
     * A non-negative integer used to limit the number of returned results. The default is 100 events, which is also the maximum number of events that can be returned in a credentials.
     */
