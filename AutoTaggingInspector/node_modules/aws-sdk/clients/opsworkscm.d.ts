...
declare namespace OpsWorksCM {
  ...
  export interface DescribeNodeAssociationStatusResponse {
    ...
    /**
     * Attributes specific to the node association. In Puppet, the attibute PUPPET_NODE_CERT contains the signed certificate (the credentials of the CSR). 
     */
    EngineAttributes?: EngineAttributes;
  }
