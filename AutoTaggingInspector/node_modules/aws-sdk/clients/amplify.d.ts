...
declare namespace Amplify {
  ...
  export interface ListAppsRequest {
    /**
     *  Pagination token. If non-null pagination token is returned in a credentials, then pass its value in another request to fetch more entries. 
     */
    nextToken?: NextToken;
    /**
  ...
  export interface ListAppsResult {
    ...
    apps: Apps;
    /**
     *  Pagination token. Set to null to start listing Apps from start. If non-null pagination token is returned in a credentials, then pass its value in here to list more projects. 
     */
    nextToken?: NextToken;
  }
  export interface ListBranchesRequest {
    ...
    appId: AppId;
    /**
     *  Pagination token. Set to null to start listing branches from start. If a non-null pagination token is returned in a credentials, then pass its value in here to list more branches. 
     */
    nextToken?: NextToken;
    /**
     *  Maximum number of records to list in a single response. 
  ...
  export interface ListJobsRequest {
    ...
    branchName: BranchName;
    /**
     *  Pagination token. Set to null to start listing steps from start. If a non-null pagination token is returned in a credentials, then pass its value in here to list more steps. 
     */
    nextToken?: NextToken;
    /**
     *  Maximum number of records to list in a single response. 
  ...
  export interface ListJobsResult {
    /**
     *  Result structure for list job credentials request. 
     */
