...
declare namespace Mobile {
  ...
  export interface ListBundlesRequest {
    ...
    /**
     *  Pagination token. Set to null to start listing bundles from start. If non-null pagination token is returned in a credentials, then pass its value in here in another request to list more bundles. 
     */
    nextToken?: NextToken;
  }
  ...
  export interface ListProjectsRequest {
    ...
    maxResults?: MaxResults;
    /**
     *  Pagination token. Set to null to start listing projects from start. If non-null pagination token is returned in a credentials, then pass its value in here in another request to list more projects. 
     */
    nextToken?: NextToken;
  }
