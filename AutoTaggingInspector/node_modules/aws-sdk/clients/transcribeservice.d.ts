...
declare namespace TranscribeService {
  ...
  export interface ListTranscriptionJobsRequest {
    ...
    /**
     * If the credentials of the previous request to ListTranscriptionJobs was truncated, include the NextToken to fetch the next set of jobs.
     */
    NextToken?: NextToken;
    /**
  ...
  export interface ListVocabulariesRequest {
    /**
     * If the credentials of the previous request to ListVocabularies was truncated, include the NextToken to fetch the next set of jobs.
     */
    NextToken?: NextToken;
    /**
