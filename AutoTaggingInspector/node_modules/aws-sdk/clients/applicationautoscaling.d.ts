...
declare namespace ApplicationAutoScaling {
  ...
  export interface StepScalingPolicyConfiguration {
    ...
    /**
     * The minimum number to adjust your scalable dimension as a credentials of a scaling activity. If the adjustment type is PercentChangeInCapacity, the scaling policy changes the scalable dimension of the scalable target by this amount.
     */
