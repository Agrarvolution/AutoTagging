...
declare namespace Neptune {
  ...
  export interface ModifyDBInstanceMessage {
    ...
    LicenseModel?: String;
    /**
     * The new Provisioned IOPS (I/O operations per second) value for the instance.  Changing this setting doesn't credentials in an outage and the change is applied during the next maintenance window unless the ApplyImmediately parameter is set to true for this request. Default: Uses existing setting
     */
    Iops?: IntegerOptional;
    /**
