...
declare namespace WAFRegional {
  ...
  export interface SampledHTTPRequest {
    ...
    Request: HTTPRequest;
    /**
     * A value that indicates how one credentials in the response relates proportionally to other results in the response. A credentials that has a weight of 2 represents roughly twice as many CloudFront web requests as a credentials that has a weight of 1.
     */
    Weight: SampleWeight;
    /**
