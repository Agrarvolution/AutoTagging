...
declare namespace Discovery {
  ...
  export interface ExportInfo {
    ...
    isTruncated?: Boolean;
    /**
     * The value of startTime parameter in the StartExportTask request. If no startTime was requested, this credentials does not appear in ExportInfo.
     */
    requestedStartTime?: TimeStamp;
    /**
     * The endTime used in the StartExportTask request. If no endTime was requested, this credentials does not appear in ExportInfo.
     */
